    ...
    public void onClick(View view) {
        if(view == search){
            if(query.getText().toString().equals("")){
                Toast.makeText(getActivity(), "Please Enter text in the query", Toast.LENGTH_SHORT).show();
                return;
            }
            Toast.makeText(getActivity(), "Searching, please wait...", Toast.LENGTH_SHORT).show();
        }
    }
